...
$(function () {
    ...
    ***************************/
    ...
    timeline.to(".tria-animation-1 .tria-h3", {
        opacity: 0,
        y: '-30',
    }, "+=.3");

    timeline.fromTo(".tria-reveal-box", 0.1, {
        opacity: 0,
    }, {
        opacity: 1,
        x: '-30',
    ...
    timeline.to(".tria-reveal-box", 0.45, {
        width: "100%",
        x: 0,
    }, "+=.1");
    ...
    timeline.fromTo(".tria-animation-2 .tria-h3", {
        opacity: 0,
    }, {
        opacity: 1,
    }, "-=.5");
    timeline.to(".tria-animation-2 .tria-h3", 0.6, {
        opacity: 0,
        y: '-30'
    }, "+=.5");
    timeline.to(".tria-preloader", 0.8, {
        opacity: 0,
        ease: 'sine',
    }, "+=.2");
    timeline.fromTo(".tria-up", 0.8, {
        opacity: 0,
        y: 40,
        scale: .98,
        ease: 'sine',
    ...
    ***************************/
    $(document).ready(function () {
        ...
        $(".tria-main-menu ul li.tria-active > a").clone().appendTo(".tria-current-page");
    });
    /***************************
    ...
    ***************************/
    ...
    $('.tria-drag').mouseover(function () {
        gsap.to($('.tria-ball .tria-icon-1'), .2, {
            scale: '1',
            ease: 'sine',
        });
    });
    ...
    $('.tria-more').mouseover(function () {
        gsap.to($('.tria-ball .tria-more-text'), .2, {
            scale: '1',
            ease: 'sine',
        });
    });
    ...
    $('.tria-choose').mouseover(function () {
        gsap.to($('.tria-ball .tria-choose-text'), .2, {
            scale: '1',
            ease: 'sine',
        });
    });
    ...
    $('a:not(".tria-choose , .tria-more , .tria-drag , .tria-accent-cursor"), input , textarea, .tria-accordion-menu').mouseover(function () {
        gsap.to($(cursor), .2, {
            scale: 0,
            ease: 'sine',
        });
        gsap.to($('.tria-ball svg'), .2, {
            scale: 0,
        });
    });

    $('a:not(".tria-choose , .tria-more , .tria-drag , .tria-accent-cursor"), input, textarea, .tria-accordion-menu').mouseleave(function () {
        gsap.to($(cursor), .2, {
            scale: 1,
            ease: 'sine',
        });
    ...
    ***************************/
    ...
    document.addEventListener("swup:contentReplaced", function () {
        ...
        ***************************/
        $(document).ready(function () {
            $(".tria-arrow-place .tria-arrow, .tria-animation .tria-dodecahedron, .tria-current-page a").remove();
            $(".tria-arrow").clone().appendTo(".tria-arrow-place");
            $(".tria-dodecahedron").clone().appendTo(".tria-animation");
            $(".tria-lines").clone().appendTo(".tria-lines-place");
            $(".tria-main-menu ul li.tria-active > a").clone().appendTo(".tria-current-page");
